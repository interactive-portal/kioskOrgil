...
//         <button
//           onClick={() => router.push("/page/extend/userinfo")}
...
//       setShowModal(true);
//     } else {
//       // If member is not found, redirect to /page/form2
//       router.push("/page/form2");
//     }
//   };
...
const Stretch = () => {
  ...
  const handleGoToRegister = () => {
    ...
    // Redirect to /page/form2 with query parameters
    router.push({
      pathname: "/page/form2",
