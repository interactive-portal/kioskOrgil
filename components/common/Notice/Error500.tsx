...
const Error500: FC<PropsType> = ({ item, customClassName, customStyle }) => {
  return (
    <div className="w-screen min-h-screen bg-[#fea918] text-white flex flex-col justify-center items-center">
      <div
      ...
      <div className="font-light" style={{ fontSize: "33px" }}>
      ...
      <div className="my-5">
        ...
        >
          <defs>
            <linearGradient
              id="af83dc26-9572-4816-b7a1-1af4f72ff554-219"
              x1="678.2"
              y1="821.79"
              x2="678.2"
              y2="493.4"
          ...
          <g opacity="0.1">
            ...
            <path
              ...
              opacity="0.1"
            />
            <circle cx="925.49" cy="102.72" r="10.69" fill="#54acae" />
            <circle cx="987.93" cy="109.58" r="10.69" fill="#54acae" />
            <circle cx="1012.01" cy="205.64" r="10.69" fill="#54acae" />
            <circle cx="979.51" cy="253.61" r="10.69" fill="#54acae" />
            <circle cx="935.11" cy="353.24" r="10.69" fill="#54acae" />
            <circle cx="935.11" cy="353.24" r="10.69" opacity="0.1" />
            <circle cx="836.39" cy="240.4" r="10.69" fill="#54acae" />
          ...
          <g opacity="0.1">
            ...
            <path
              ...
              opacity="0.1"
            />
            <circle cx="48.97" cy="324.78" r="5.39" fill="#54acae" />
            <circle cx="17.51" cy="328.24" r="5.39" fill="#54acae" />
            <circle cx="5.39" cy="376.63" r="5.39" fill="#54acae" />
            <circle cx="21.76" cy="400.8" r="5.39" fill="#54acae" />
            <circle cx="44.12" cy="450.99" r="5.39" fill="#54acae" />
            <circle cx="44.12" cy="450.99" r="5.39" opacity="0.1" />
            <circle cx="93.85" cy="394.14" r="5.39" fill="#54acae" />
          ...
          <path
            ...
            transform="translate(-88.65 -57.09)"
            fill="url(#af83dc26-9572-4816-b7a1-1af4f72ff554-219)"
          />
          <path
      ...
      <div className="my-5">
        <div>Алдаа: {item?.title}</div>
        <div>Тайлбар: {item?.description}</div>
      </div>
    </div>
  );
};
